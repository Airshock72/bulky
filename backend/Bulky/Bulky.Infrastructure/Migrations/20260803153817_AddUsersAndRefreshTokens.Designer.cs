...
namespace Bulky.Infrastructure.Migrations
{
    ...
    [Migration("20260803153817_AddUsersAndRefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bulky.Domain.Entities.Amenity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bulky.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bulky.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bulky.Domain.Entities.VillaNumber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bulky.Domain.Entities.Amenity", b =>
                {
                    b.HasOne("Bulky.Domain.Entities.Villa", "Villa")
                        .WithMany("Amenities")
            ...
            modelBuilder.Entity("Bulky.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("Bulky.Domain.Entities.User", "User")
